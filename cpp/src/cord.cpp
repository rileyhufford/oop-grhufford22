...
namespace power
{
    ...
    : m_constructedOn(copy.m_constructedOn), m_length(copy.m_length), 
    m_connector(copy.m_connector), m_capacity(copy.m_capacity)
    {
        std::cout << "Cord@" << (void*) this << " copied from" << (const void*) &copy << std::endl;
    }
    ...
    {
        std::cout << "Cord@" << (void*) this << " on line" << m_constructedOn <<"constructed." << std::endl;
    }

    Cord::~Cord()
    {
        std::cout << "Cord@" << (void*) this << " from line" << m_constructedOn << "destructed." << std::endl;
    }
